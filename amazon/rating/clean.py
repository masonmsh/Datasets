...
def parse_args():
    ...
    parser.add_argument('--drop', type=int, default=20, help='Drop threshold')
...
if __name__ == '__main__':
    ...
    drop = args.drop
    inpath = '../../data/amazon/rating/alpha/' + filename + '.csv'
    outpath = '../../data/amazon/rating/beta/' + filename + '.csv'
