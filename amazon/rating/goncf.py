...
if __name__ == '__main__':
    ...
    inpath = '../../data/amazon/rating/beta/' + filename + '.csv'
    trainpath = '../../data/amazon/rating/ncf/' + filename + '.train.rating'
    testpath = '../../data/amazon/rating/ncf/' + filename + '.test.rating'
    negapath = '../../data/amazon/rating/ncf/' + filename + '.test.negative'
